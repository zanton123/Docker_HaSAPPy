...
# Usage:
#       xhost +local:root
#       sudo docker run -it -v <DATA PATH>:/data -v /tmp/.X11-unix:/tmp/.X11-unix -e DISPLAY=$DISPLAY zanton123/hasappy:ubuntu14.04
#       xhost -
...
# ENV PYTHONPATH ${PYTHONPATH}:/HaSAPPy/HaSAPPy
...
# this is the CPU version of PreprocessReads as the image does not provide GPU support:
...
# Generate annotation databasescd ..

...
echo '------------------------------------------------------------------'
echo
echo 'This container runs HaSAPPy interactively and produces output in'
echo 'the /data folder, which should be maped to an external volume with'
echo
echo ' docker run -it -v <DATA PATH>:/data zanton123/hasappy:ubuntu14.04'
echo
...
echo
echo 'HaSAPPy supports the use of Nvidia GPUs and for some functionality'
echo 'requires it. A docker image for running HaSAPPy using nvidia-docker'
echo 'is available with the tag GPU:'
echo
echo '    zanton123//hasappy:GPU'
echo
echo 'This is the preferred solution for accessing the full functionality'
echo 'of HaSAPPy.'
echo
